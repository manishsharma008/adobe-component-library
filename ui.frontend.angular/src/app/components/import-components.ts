 ...
 */
MapTo('adobe-component-library/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('adobe-component-library/components/separator')(SeparatorV1Component);

MapTo('adobe-component-library/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('adobe-component-library/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('adobe-component-library/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('adobe-component-library/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('adobe-component-library/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('adobe-component-library/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('adobe-component-library/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('adobe-component-library/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('adobe-component-library/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('adobe-component-library/components/accordion')(AccordionV1Component);
MapTo('adobe-component-library/components/tabs')(TabsV1Component);
...
LazyMapTo('adobe-component-library/components/teaser')(TeaserV1Component);
...
LazyMapTo('adobe-component-library/components/carousel')(CarouselV1Component);
...
LazyMapTo('adobe-component-library/components/text')(LazyTextModule, TextEditConfig);